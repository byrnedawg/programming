...
// Use PWM output
void motorPWMInit(MOTOR_DRIVER* driver);

// Use code in Motors/L293D.c
void motorL293Init(MOTOR_DRIVER* driver);

// SN754410 is pseudonym for L293
static __inline__ void motorSN754410Init(MOTOR_DRIVER* driver){
	motorL293Init(driver);
}
