...
/* ------------------------------------------------------
 * $Id: babyOrangutanB328.h,v 1.4 2010/09/22 16:09:22 clivewebster Exp $
 *
 * Revision History
 * ================
...
TOSHIBA_TB6612FNG_2pin_MOTOR_LIST onboard_motors[] = {&Motor1, &Motor2};
...
#ifdef USE_ON_BOARD_MOTORS
	toshibaTB6612FNG_2pin_Init(&onboard_driver);
#endif
}
