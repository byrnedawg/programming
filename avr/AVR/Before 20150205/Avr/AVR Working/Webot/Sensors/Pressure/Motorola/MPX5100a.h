/*
 * $Id: MPX5100a.h,v 1.5 2010/06/14 19:09:50 clivewebster Exp $
 *
 * Revision History
 * ================
 * $Log: MPX5100a.h,v $
 ...
 *
 *  The returned value is relative to when the device was initialised with pressureInit
 *
 */
...
typedef struct s_MPX5100A{
	PRESSURE	 pressure;
	ADC_CHANNEL  adcPin;
	uint16_t	 initial;		// The adc value at init
} MPX5100A;
