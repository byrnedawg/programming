...
/*
 * $Id: LY530ALH.c,v 1.6 2010/07/19 19:55:08 clivewebster Exp $
 *
 * Revision History
 * ================
 * $Log: LY530ALH.c,v $
...
// 0.3 at 10 bit
static const uint16_t PROGMEM ly530alh_slow_frac[]     = {0, 4, 20, 0};
// 1.2 at 10 bit
static const uint16_t PROGMEM ly530alh_fast_frac[]     = {1, 5, 0};
