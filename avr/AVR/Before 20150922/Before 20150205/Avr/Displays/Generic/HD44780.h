/*
 * $Id: HD44780.h,v 1.2 2010/06/14 18:45:05 clivewebster Exp $
 *
 * Revision History
 * ================
 * $Log: HD44780.h,v $
...
typedef struct s_hd44780{
	...
	uint8_t*	buffer;		// The character buffer
} HD44780;

#define MAKE_HD44780_8PIN(columns, rows ,rs,rw,e,d0,d1,d2,d3,d4,d5,d6,d7, writer) {\
	MAKE_DISPLAY(&c_HD44780, columns, rows, writer), rs,rw,e, {d0,d1,d2,d3,d4,d5,d6,d7}, FALSE, null \
}

#define MAKE_HD44780_4PIN(columns, rows,rs,rw,e,d4,d5,d6,d7, writer) {\
	MAKE_DISPLAY(&c_HD44780, columns, rows, writer), rs,rw,e, {null,null,null,null, d4,d5,d6,d7}, TRUE, null \
}
