/*
 * $Id: _encoder_common.h,v 1.9 2010/09/08 18:25:32 clivewebster Exp $
 *
 * Revision History
 * ================
...
#define encoderSubtract( encoder,count ) _encoderSubtract((&(encoder)->encoder),count)
void _encoderSubtract(ENCODER* encoder, ENCODER_TYPE count);

// Return how many ticks there are per revolution
#define encoderTicksPerRevolution(encoder) _encoderTicksPerRevolution((&(encoder)->encoder))
