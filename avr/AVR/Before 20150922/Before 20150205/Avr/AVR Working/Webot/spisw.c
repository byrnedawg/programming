/*
 * $Id: spisw.c,v 1.9 2010/07/01 23:55:27 clivewebster Exp $
 *
 * Revision History
 * ================
 * $Log: spisw.c,v $
...
SPI_CLASS c_sw_spi = MAKE_SPI_CLASS(&__spiSWInit, &__spiSWOff,&__spiSWSetClock,&__spiSWSetDataOrder, &__spiSWSetMode,&__spiSWSendByte,&readMany,&writeMany,&select);
