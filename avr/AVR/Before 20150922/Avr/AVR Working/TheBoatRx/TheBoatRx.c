...
#define        TX_PS2_RX            3
#define        TX_PS2_RY            4
#define        TX_PS2_X_Pressure    5
#define        TX_PS2_SQ_Pressure   6
#define        TX_PS2_DR_Pressure   7
#define        TX_PS2_DL_Pressure   8
#define        TX_PS2_1             9
#define        TX_END               10
...
SANYO_LB1836M_MOTOR Motor = MAKE_SANYO_LB1836M_MOTOR(FALSE, D5, D6);
SANYO_LB1836M_MOTOR_LIST onboard_motors[] = {&Motor};
