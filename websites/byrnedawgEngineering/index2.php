...
*/
  #logo {padding-top:20px; padding-bottom:20px;cursor:default; pointer-events: none;}
...
<div class="container-fluid no-padding" style="color: black; background-color: Black;">
    <div class="container">
        <img id = "logo" class="img-responsive center-block " src="imgs/byrnedawgEngineeringLogo2.jpg" alt="Logo" height = "50 px"> 
    </div>
</div>

<nav id = "nav1" class="navbar navbar-inverse" data-spy="affix" data-offset-top="100"> <!-- navbar-fixed-top-->
...
<div id="section1" class="container-fluid">
      ...
      <div class = "row">
        ...
        <div class = "col-sm-8 col-md-8 col-lg-8">
          <div class = "center-block well" style = "background-color: rgba(48, 48, 48, .5);">
            <p class = "text-center" style = "font-size: 18px; color: white"> <strong>Everyone has a great idea but not everyone is an Engineer...<br>Thats where Byrnedawg Engineering comes in.</strong>  </p>
          </div>
        </div>
      <div class = "col-sm-2 col-md-2 col-lg-2">
      </div>
  ...
  <div class="container" style = "background: rgb(48,48,48);">
    ...
    <p class = "text-left well" style = "background: rgba(128, 128, 128, .5);">My name is Greg Byrne and I’m an Electrical and Computer Engineer who currently works for the Department of Defense. I have Masters of Engineering in Computer Engineering from Stevens Institute of Technology and a Bachelor’s of Science in Electrical and Computer Engineering from Rowan University. I have experience in dealing with the full life cycle of a product within the DOD. I feel I can take this knowledge and experience from the DOD world and apply it to the development of consumer products. I personally believe that if you are not always trying to progress your skills and knowledge you end up regressing. This is the reason I decided to start Engineering consulting. I wanted the opportunity to work on projects outside the scope of my daily work and take your ideas and create new innovative products and design solutions. </p>
  </div>
</div>
  ...
  <div class = "row">
    ...
    <div class = "col-sm-6 col-md-6 col-lg-4">
        <div class = "well" style = "background: rgba(128, 128, 128, .5);">
          <p><strong>Convert your Idea into a Product</strong></p>
          <ul>
            <li>Help you determine if your idea is a feasible design solution to a problem and that your idea doesn’t exist in some other form somewhere else</li>
            <li>Take your idea to the next level by building prototypes for evaluation and proof of concept</li>
            <li>Refine design to deliver a product that meets industry and market requirements</li>
            <li>Provide Technical Data Package of design solution to move forward with patent application and/or production</li>
          </ul>
        </div>
    </div>
    <div class = "col-sm-6 col-md-6 col-lg-4">
  ...
  <div class = "row">    
    ...
    <div class = "col-sm-6 col-md-6 col-lg-4 col-sm-push-6 col-md-push-6 col-lg-push-4">
        <div class = "well center-block" style = "background: rgba(128, 128, 128, .5);">
          ...
          <ul>
            <li>If you have a need for a website to promote your Idea or Business I can design and build customized interactive websites</li>
           </ul>
        </div>
    </div>
...
<h1 class = "text-center">PROJECTS</h1>
  <div class = "row">
   <div class = "col-sm-2 col-md-2 col-lg-2">
    ...
    <div class = "col-sm-8 col-md-8 col-lg-8">
      <div class = "well center-block" style = "background: rgba(128, 128, 128, .5);">
        <p class = "text-center">Here are some projects worked on in the past.</p>
        <div class = "row">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item fixed-height">
        <img src="imgs/d-latchLedit.jpg" alt="D-Latch">
      </div>
...
<div class="container-fluid" style = "padding-top:10px; padding-bottom:10px; background-color: LightGray;">
    <div class="row">
  	    <div class="col-lg-2">
