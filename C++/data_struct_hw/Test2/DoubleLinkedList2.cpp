...
public:
	...
	void addEnd(int v) {
		...
		cout <<"\n The Head is pointing to " << head -> val << "\n";
		cout <<"\n The Tail is pointing to " << tail -> val << "\n";
		cout << "\n The previous value is pointing to " << tail-> prev -> val << "\n";
		count++;
	}
 ...
 { 
	...
	for ( ; i > 0; i--, p = p->next)
		if (p == nullptr)
			throw "DoubleLinkedList2 index out of bounds";
...
{
	DoubleLinkedList2 commandLineList;
	int answer = 0;
	int value = 0;
	int pos = 0;
