/*
https://www.khanacademy.org/computing/computer-programming/sql/more-advanced-sql-queries/p/project-data-dig
...
SELECT name AS "Players selected from Florida" FROM picks WHERE college = "Florida";

SELECT college as "Position college Selections" FROM picks WHERE position = "QB";

SELECT name, position, college AS "Giants Picks" FROM picks WHERE picked_by = "New York Giants" Order BY pick_number; 

SELECT name, position, college FROM picks
AS "MyTableName" WHERE picked_by = "New York Giants" AND pick_number < 50 Order by college ;

SELECT * FROM picks WHERE picked_by = "New York Giants" OR picked_by = "New York Jets" OR picked_by = "New Orleans";

SELECT * FROM picks WHERE picked_by = "New York Giants" GROUP BY picked_by HAVING pick_number < 54;

SELECT * FROM picks WHERE position = "WR" OR position = "QB" OR position = "RB" OR position = "OG" OR position = "OT" OR position = "C" OR position = "TE";